...
// Full-page easy Wheel route (/games/wheel): fixed top bar + the existing
// wheel experience, moved verbatim from the old combined Games page. No
// changes to wheel logic whatsoever.
export default function GamesWheel() {
  ...
  return (
    <Page className="wrap-app pb-16 pt-6">
      <Seo title="easy Wheel — Spin & Win Free Data | easy" noindex />
      <GameTopBar title="easy Wheel" />
